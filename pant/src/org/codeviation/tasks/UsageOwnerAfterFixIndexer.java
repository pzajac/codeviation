...
public class UsageOwnerAfterFixIndexer extends UsageOwnerIndexer {
    ...
    public String getName() {
        return "UsageOwnerAfterFixIndexer";
    }
    
    @Override
    public String getDescription() {
        return "Usage of bug  before bugfix for developer";
    }
